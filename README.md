...
[![GitCI.cn](https://gitci.cn/api/badges/jqiris/builder/status.svg)](https://gitci.cn/jqiris/builder)  [![codecov](https://codecov.io/gh/jqiris/builder/branch/master/graph/badge.svg)](https://codecov.io/gh/jqiris/builder)
[![](https://goreportcard.com/badge/github.com/jqiris/builder)](https://goreportcard.com/report/github.com/jqiris/builder)

Package builder is a lightweight and fast SQL builder for Go and XORM.

Make sure you have installed Go 1.8+ and then:

    go get github.com/jqiris/builder
...
```Go
import . "github.com/jqiris/builder"
